Using the following bindings guide:
...
Write bindings for the following api given the documentation:
...
Focus more on the documentation for reference, but consulting the implementation for clarity.
