...
[@mel.module "react-native"] [@mel.scope "Easing"] external bounce: t = "bounce";
[@mel.module "react-native"] [@mel.scope "Easing"] external circle: t = "circle";
...
[@mel.module "react-native"] [@mel.scope "Easing"] external linear: t = "linear";
[@mel.module "react-native"] [@mel.scope "Easing"] external out: t => t = "out";
[@mel.module "react-native"] [@mel.scope "Easing"]
