...
[@mel.module "react-native"] [@mel.scope "Easing"] external step0: t = "step0";

[@mel.module "react-native"] [@mel.scope "Easing"] external step1: t = "step1";
...
[@mel.module "react-native"] [@mel.scope "Easing"]
external elastic: option(float) => t = "elastic";

[@mel.module "react-native"] [@mel.scope "Easing"]
external back: option(float) => t = "back";
